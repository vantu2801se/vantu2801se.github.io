const ENLISH = {
    ...
    "experience_timeline_1_do_1": "Developed modular programs such as batch jobs, cron jobs, webhooks and web services in microservice system using Golang and established communication between services with service, or with cloud such as API Gateway, Redis, SQS, S3, and GCS across different cloud platforms. Responsible for business logic, ensure unit testing, perform regression,integration test when developing services",
    "experience_timeline_1_do_2": "Established service communication between multiple clouds, specifically AWS and GCP using IAM/Cloud Identity",
    "experience_timeline_1_do_3": "Participate in batch performance optimization as well as database performance improvement",
    "experience_timeline_1_do_4": "Participated in system design, created basic and detailed designs using as PlantUML",
    "experience_timeline_1_do_5": "Create S3/GCP buckets, configure API Gateway, set up log monitoring and alerting through Datadog SaaS, and establish the connection between Fastly CDN and GCS using Terraform IaC",
    "experience_timeline_1_do_6": "Performed unit testing, configured to push to Docker image to registry and deployment to K8S using CI/CD tools such as CircleCI and GitHub Actions",
    "experience_timeline_1_do_7": "Participate in refactoring Terraform source to achieve scalability efficiency",
    "experience_timeline_1_do_8": "Responsible for writing CircleCI/Github Action pipeline for deploying service, fixing some CI errors or upgrading Go, Docker, Ubuntu version",
    "experience_timeline_1_do_9":"Migrate service running on K8S workload from Standard to autopilot cluster", 
