const ENLISH = {
    ...
    "experience_timeline_1_do_1": "Developed modular programs such as batch jobs, cron jobs, webhooks and web services in microservice system using Golang and established communication between services with service, or with cloud such as API Gateway, Redis, SQS, S3, and GCS across different cloud platforms",
