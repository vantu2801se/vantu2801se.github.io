...
export default function KeyCapabilities(){
    ...
    const keys = [t("key_capabilities_content_1"),t("key_capabilities_content_2"),t("key_capabilities_content_3"),t("key_capabilities_content_4"),t("key_capabilities_content_5")];
